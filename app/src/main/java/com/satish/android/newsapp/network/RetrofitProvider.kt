...
import com.satish.android.newsapp.utility.Constants.API_CONNECT_TIMEOUT_VALUE
import com.satish.android.newsapp.utility.Constants.API_READ_TIMEOUT_VALUE
import com.satish.android.newsapp.utility.defaultLocale
import com.satish.android.newsapp.utility.deviceId
...
class RetrofitProvider private constructor() {
    ...
    companion object {
        private const val API_KEY="640a9e0ffea44ec297001f96328d1833"
        ...
        private fun createCertificatePinner(): CertificatePinner {
            val host = NewsApplication.instance.getString(R.string.base_url)
                .replace("https://", "")
        ...
        private fun createRetrofitClient(okttpClientBuilder: OkHttpClient.Builder) =
            Retrofit.Builder()
                .baseUrl(NewsApplication.instance.getString(R.string.base_url))
        ...
        private val headerInterceptor: Interceptor
            get() = Interceptor { chain ->
                ...
                try {
                    with(jsonObject) {
                        // satish: below part is addition adding
